...
- Deye CAN, Growatt CAN, Growatt RS485, JKBMS CAN, and JKBMS Modbus protocol map documentation.
...
- Active decoder set is currently limited to validated decoders: `Deye CAN`, `Growatt CAN`, `Growatt RS485`, `JKBMS CAN`, and `JKBMS Modbus`.
