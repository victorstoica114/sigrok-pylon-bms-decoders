...
try:
    from .pylon_can import FRAME_NAMES, VERSION, describe_packet, format_data, frame_summary
except Exception:
    from pylon_can import FRAME_NAMES, VERSION, describe_packet, format_data, frame_summary
...
class Decoder(BaseDecoder):
    api_version = 3
    id = 'pylon_can'
    name = 'Pylon CAN {}'.format(VERSION)
    longname = 'Pylon-compatible CAN {}'.format(VERSION)
