...
\item Anenji Pylon RS485 JKBMS shows the clearest RS485 latency change: Direct cable is -4581.73 (-47.2\%) versus Bridge for request-to-response average.
\item Growatt RS485 JKBMS has a much longer Direct cable tail latency: Direct cable is +21480.84 (+40.1\%) versus Bridge for full-exchange P95.
\item Growatt CAN SeplosBMS cycles are shorter in Direct cable mode: Direct cable is -164247.78 (-19.3\%) versus Bridge for cycle average.
\item Growatt CAN JKBMS frame rate stays effectively flat across modes: Direct cable is +0.1 (+0.2\%) versus Bridge.
\end{itemize}
\end{tcolorbox}
...
Growatt CAN JKBMS & Cycle min (us) & \decrease{-5000467.18 (-50.1\%)} & 50.1\% \\
Growatt CAN JKBMS & Cycle avg (us) & \decrease{-5000467.18 (-50.1\%)} & 50.1\% \\
Growatt CAN JKBMS & Cycle max (us) & \decrease{-5000467.18 (-50.1\%)} & 50.1\% \\
Growatt CAN JKBMS & Cycle P95 (us) & \decrease{-5000467.18 (-50.1\%)} & 50.1\% \\
Growatt CAN SeplosBMS & Cycle min (us) & \decrease{-121301.9 (-48.3\%)} & 48.3\% \\
\bottomrule
\end{tabularx}
\end{table}
