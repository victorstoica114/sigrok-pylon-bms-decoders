...
An Overleaf-ready visual report is generated at [latex/main.tex](latex/main.tex).
It is self-contained, while local PDF/build artifacts under `analysis/latex/build/`
are ignored by git.
