# PACE Modbus Register Map

Protocol: PACE BMS Modbus Protocol for RS485 V1.3.

This map follows the PACE poll blocks used by `decoders/pace_modbus` for the
current Growatt/JKBMS bridge tests.

- Default slave address: `0x01`
- Supported read functions: `0x03`, `0x04`
- Poll blocks: `0x0000` count `0x000D`, `0x000F` count `0x0016`

## PACE Modbus Runtime Registers
